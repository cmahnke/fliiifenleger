 ...
 *
 * <p>The {@link GainMapTileEnricher} checks for this capability; when
 * present, each tile is accompanied by the correspondingly cropped gain map
 * (passed through the metadata map, see the {@link GainMapData} key
 * constants), which UltraHDR sinks re-embed into the tiles.
 */
